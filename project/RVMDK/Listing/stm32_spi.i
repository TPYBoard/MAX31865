...
#line 29 "..\\bsp_lib\\stm32_spi.c"

volatile uint32_t    TIMEOUT=((uint32_t)(10 *((uint32_t)0x1000)));
...
void  SPI_Inital(void)
{
 ...
 GPIO_InitTypeDef  GPIO_InitStructure;
   ...
   GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0020)|((uint16_t)0x0080)|((uint16_t)0x0040);
...
uint8_t SPI_Write(uint8_t *buffer, uint8_t nBytes)
{
  ...
  for(i=0;i<nBytes;i++)
     {
       TIMEOUT = ((uint32_t)(10 *((uint32_t)0x1000)));
       while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), ((uint16_t)0x0002)) == RESET)  
             {
                if((TIMEOUT--) == 0) return (1);
             }
       SPI_I2S_SendData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)),buffer[i]);
  ...
  for(i=0;i<nBytes;i++)
     {
       ...
       buffer[i]= SPI_I2S_ReceiveData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)));
     }
  return(0);
}
...
uint8_t SPI_ReadByte(void)
{
      SPI_I2S_ReceiveData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)));
       ...
       SPI_I2S_SendData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)),0xff);
...
uint8_t DRDY_Pin_Value(void)
{
   return(GPIO_ReadOutputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0020)));      
}
...
void Enable_Exti(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000010) | ((uint32_t)0x00000001),ENABLE);       
  ...
  GPIO_EXTILineConfig(((uint8_t)0x02), ((uint8_t)0x00));  
