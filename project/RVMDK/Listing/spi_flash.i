...
#line 19 "..\\bsp_lib\\spi_flash.c"

 


 
#line 33 "..\\bsp_lib\\spi_flash.c"
...
void SPI_FLASH_Init(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00001000) | ((uint32_t)0x00000004) |
...
void SPI_FLASH_BufferWrite(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite)
{
  ...
  Addr = WriteAddr % 0x200;
  count = 0x200 - Addr;
  NumOfPage =  NumByteToWrite / 0x200;
  NumOfSingle = NumByteToWrite % 0x200;
  ...
  if (Addr == 0)  
  {
    ...
    else  
    {
      while (NumOfPage--)
      {
        SPI_FLASH_PageWrite(pBuffer, WriteAddr, 0x200);
        WriteAddr +=  0x200;
        pBuffer += 0x200;
      }
...
u16 SPI_FLASH_SendHalfWord(u16 HalfWord)
{
  ...
  SPI_I2S_SendData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), HalfWord);
